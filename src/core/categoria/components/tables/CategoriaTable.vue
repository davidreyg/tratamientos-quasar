...
import { Categoria, useCategoriaDeleteMutation } from 'core/categoria';
import { QTable } from 'quasar';
import BaseTable from 'shared/components/base/BaseTable.vue';
import { ServerPagination } from 'shared/utils';
import Swal from 'sweetalert2';
import { PropType } from 'vue';
import CategoriaTableActions from './CategoriaTableActions.vue';
defineProps({
  loading: {
    type: Boolean,
    required: false,
...
const { mutateAsync } = useCategoriaDeleteMutation();
