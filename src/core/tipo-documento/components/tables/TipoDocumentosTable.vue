...
import {
  TipoDocumento,
  useTipoDocumentoDeleteMutation,
...
import TipoDocumentosTableActions from './TipoDocumentosTableActions.vue';
defineProps({
  loading: {
    type: Boolean,
    required: false,
...
const { mutateAsync } = useTipoDocumentoDeleteMutation();
