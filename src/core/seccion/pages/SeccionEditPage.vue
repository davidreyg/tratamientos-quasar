...
import SeccionEditForm from '../components/forms/SeccionEditForm.vue';
import { useSeccionFetchByIdQuery } from '../composables';
...
const { data, isSuccess, isFetching } = useSeccionFetchByIdQuery(
  props.id,
  true
);
const onSubmit = () => {
