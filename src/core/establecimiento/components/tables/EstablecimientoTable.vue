...
import {
  Establecimiento,
  useEstablecimientoDeleteMutation,
...
import EstablecimientoTableActions from './EstablecimientoTableActions.vue';
defineProps({
  loading: {
    type: Boolean,
    required: false,
...
const { mutateAsync } = useEstablecimientoDeleteMutation();
